...
from models.modules.flow_comp import flow_warp
...
class SecondOrderDeformableAlignment(ModulatedDeformConv2d):
    ...
    def forward(self, x, extra_feat, flow_1, flow_2):
        # print('shape 1: ', x.shape, extra_feat.shape, flow_1.shape, flow_2.shape)
        extra_feat = torch.cat([extra_feat, flow_1, flow_2], dim=1)
        out = self.conv_offset(extra_feat)
        # print('shape 2: ', out.shape)
        o1, o2, mask = torch.chunk(out, 3, dim=1)
        # print('shape 3: ', o1.shape, o2.shape, mask.shape)
        # offset
        ...
        # assert 1==2, print('shape 4: ', mask.shape)
